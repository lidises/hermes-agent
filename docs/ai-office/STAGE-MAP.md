...
- Current requested rung: next Stage 13 visual slice should improve block-internal sprite movement/readability before name/status bubble polish: actors should patrol within bounded room blocks or explicit corridor lanes. Do not force-replay failed_guarded or already-succeeded queue items.
