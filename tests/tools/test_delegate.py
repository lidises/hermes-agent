...
class TestDelegateHeartbeat(unittest.TestCase):
    ...
    def test_heartbeat_still_trips_idle_stale_when_no_tool(self):
        ...
        # Patch the idle stale ceiling down to keep the test fast while still
        # proving the no-tool branch stops heartbeats after repeated stale
        # cycles. At interval 0.05s and idle threshold 5, stale detection
        # trips at ~0.25s.
        with patch("tools.delegate_tool._HEARTBEAT_INTERVAL", 0.05), \
