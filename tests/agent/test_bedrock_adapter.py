...
class TestResolveBedrocRegion:
    ...
    def test_defaults_to_us_east_1(self):
        ...
        with patch("agent.bedrock_adapter._get_botocore_session", return_value=mock_session):
    ...
    def test_botocore_failure_falls_back_to_us_east_1(self):
        ...
        with patch("agent.bedrock_adapter._get_botocore_session", side_effect=Exception("no botocore")):
            assert resolve_bedrock_region({}) == "us-east-1"
