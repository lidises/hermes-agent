...
class EventBridge:
    ...
    def _poll_once(self, db):
        ...
        previous_sessions_json_mtime = self._sessions_json_mtime
        sessions_changed = sj_mtime != previous_sessions_json_mtime
        if sessions_changed:
        ...
        if not sessions_changed and db_mtime == self._state_db_mtime:
